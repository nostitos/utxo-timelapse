...
# Supervise the full 4K render with the selected crisp whale-star silhouette.
# The listener starts first; exit codes and external signals are preserved in a
# dedicated log so this run cannot overwrite or be confused with earlier videos.
set -uo pipefail

WORKSPACE="/Users/t/Documents/Kode/Workspaces/Clone UTXO visualizer"
RENDER_DIR="/Volumes/4T Data/buv_render"
VIDEO_OUT="$RENDER_DIR/utxo_4k_epoch105k_60fps_exactledger_weighted_topband_flashvaluefix_crisp.mkv"
FFMPEG_LOG="$RENDER_DIR/ffmpeg_4k_weighted_topband_flashvaluefix_crisp.log"
RENDER_LOG="$RENDER_DIR/render_4k_weighted_topband_flashvaluefix_crisp.log"
SUPERVISOR_LOG="$RENDER_DIR/supervisor_4k_weighted_topband_flashvaluefix_crisp.log"
FFMPEG_PID_FILE="$RENDER_DIR/ffmpeg_4k_weighted_topband_flashvaluefix_crisp.pid"
RENDER_PID_FILE="$RENDER_DIR/render_4k_weighted_topband_flashvaluefix_crisp.pid"
