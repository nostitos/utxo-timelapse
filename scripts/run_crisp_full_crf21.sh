...
# Supervise the full 4K render using software HEVC at CRF 21 in YUV 4:4:4.
...
RUN_TAG="4k_weighted_topband_flashvaluefix_crisp_crf21"
VIDEO_OUT="$RENDER_DIR/utxo_4k_epoch105k_60fps_exactledger_weighted_topband_flashvaluefix_crisp_crf21.mkv"
