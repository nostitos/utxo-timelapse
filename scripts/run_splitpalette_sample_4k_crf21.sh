...
# Supervise the 4K 200,000-207,200 split-palette review sample. Existing
# artifacts are never overwritten.
set -uo pipefail

WORKSPACE="/Users/t/Documents/Kode/Workspaces/Clone UTXO visualizer"
RENDER_DIR="/Volumes/4T Data/buv_render"
RUN_TAG="4k_blocks200000_207200_splitpalette10btc_crf21"
...
ffmpeg -nostdin -hide_banner -stats_period 15 -y \
...
/usr/bin/caffeinate -i ./build_local/buv -ns -tc=visualizer \
    -cfg=configs/buv_whaleflash_sample_4k_splitpalette.json \
