...
# Supervise the full 4K render with the exact-density epsilon cleanup using
# software HEVC at CRF 21 in YUV 4:4:4. Existing artifacts are never overwritten.
set -uo pipefail

WORKSPACE="/Users/t/Documents/Kode/Workspaces/Clone UTXO visualizer"
RENDER_DIR="/Volumes/4T Data/buv_render"
RUN_TAG="4k_weighted_topband_flashvaluefix_crisp_crf21_epsfix"
VIDEO_OUT="$RENDER_DIR/utxo_4k_epoch105k_60fps_exactledger_weighted_topband_flashvaluefix_crisp_crf21_epsfix.mkv"
...
record "starting full visualizer"
cd "$WORKSPACE" || exit 1
